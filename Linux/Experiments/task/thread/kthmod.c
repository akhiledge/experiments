...
//    void *slot_adr = NULL;
    ...
    printk ("pt(v) = %.8x\n",((unsigned int *)(myptr)));                        
    printk ("pt(v) = %.8x\n",((unsigned int *)(myptr)));  
/*    printk ("prio %d", (int )(myTask->prio));
    printk ("static_prio %d", (int )(myTask->static_prio));
    printk ("normal_prio %d", (int )(myTask->normal_prio));
    printk ("rt_prio %d", (myTask->rt_priority));
    printk ("num1 %x",num1);
    */
